...
<body>
    ...
    추가하고싶은 코스이름  <input type="text" name="course_name"><br/><br>
    주변역  <input type="text" name="stopover_stations"><br/><br><br>
	<div class="page">
		<form action="/addCourses" method="post">
  <label class="field a-field a-field_a1">
    <input class="field__input a-field__input" type="text" name="course_name" placeholder="e.g. Stanislav" required>
    <span class="a-field__label-wrap">
      <span class="a-field__label">추가하고싶은 코스이름</span>
    </span>
  </label>
  <label class="field a-field a-field_a2">
    <input class="field__input a-field__input" name="near_stations"placeholder="e.g. Melnikov" required>
    <span class="a-field__label-wrap">
      <span class="a-field__label">주변역</span>
    </span>
  </label>    
		</form>
</div>
